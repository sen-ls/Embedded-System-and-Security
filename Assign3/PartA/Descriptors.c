...
/** HID class report descriptor. This is a special descriptor constructed with
  ...
  *  its contents used to determine what data (and in what encoding) the device
  *  will send, and what it may be sent back from the host. Refer to the HID
  *  specification for more details on HID report descriptors.
  **/
const USB_Descriptor_HIDReport_Datatype_t KeyboardReport[] = {
	// Try Keyboard descriptor ....
	//  From HIDClassCommon.h, set max keys to 6 for compliance
...
/** Configuration descriptor structure. This descriptor, located in FLASH memory,
  ...
  *  selecting a configuration so that the host may correctly communicate with
  *  the USB device.
  **/
const USB_Descriptor_Configuration_t ConfigurationDescriptor = {
	...
	.HID_ReportINEndpoint = {
		...
		.Attributes             = ( EP_TYPE_INTERRUPT     |
									...
									ENDPOINT_USAGE_DATA ),
		.EndpointSize           = KEYBOARD_REPORT_SIZE,
...
/** Product descriptor string. This is a Unicode string containing the product's
  ...
  *  when the appropriate string ID is requested, listed in the Device Descriptor.
  **/
